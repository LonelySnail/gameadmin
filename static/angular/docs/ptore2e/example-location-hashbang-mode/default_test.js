describe("", function() {
  ...
  beforeEach(function() {
    ...
    browser.get("build/docs/examples/example-location-hashbang-mode/index.tpl");
  });
  
var addressBar = element(by.css("#addressBar")),
     url = 'http://www.example.com/base/index.tpl#!/path?a=b#h';
...
it("should change $location accordingly", function(){
  ...
  expect(addressBar.getAttribute('value')).toBe("http://www.example.com/base/index.tpl#!/first?a=b");
  ...
  expect(addressBar.getAttribute('value')).toBe("http://www.example.com/base/index.tpl#!/sec/ond?flag#hash");
